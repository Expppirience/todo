...
import {ADD_TODOLIST, CHANGE_TODOLIST_FILTER, CHANGE_TODOLIST_TITLE, REMOVE_TODOLIST} from "./state/actionCreators";
...
function AppWithReducer() {
   ...
   const todoLists = useSelector<AppStateType, TodoListsType[]>(todoListsSelector)
